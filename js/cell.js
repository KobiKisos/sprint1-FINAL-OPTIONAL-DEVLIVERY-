//Creating a "Cell" class which I used to create individual "cell objects" which I assigned properties to: row#, col#, bomb t/f, # of adjacent bombs
// ( reveal t/f, and flagged t/f.)
class  Cell {
